...
#define _FSCVRT_FLOAT2SHORT(x) ((x) < -32767.5f ? -32768 : ((x) > 32766.5f ? 32767 : (short)floor(.5 + (x))))
...
static const float _FSCVRT_1over3_LOWPASS_G[_FSCVRT_1over3_LOWPASS_NSEC] = {
  ...
  3.1704682e-01f,3.1704682e-01f,3.1704682e-01f,3.1704682e-01f,3.1704682e-01f
};
...
static const float _FSCVRT_1over4_LOWPASS_G[_FSCVRT_1over4_LOWPASS_NSEC] = {
  ...
  2.7502688e-01f,2.7502688e-01f,2.7502688e-01f,2.7502688e-01f,2.7502688e-01f
};
...
static const float _FSCVRT_1over6_LOWPASS_G[_FSCVRT_1over6_LOWPASS_NSEC] = {
  ...
  2.3765156e-01f,2.3765156e-01f,2.3765156e-01f,2.3765156e-01f,2.3765156e-01f
};
